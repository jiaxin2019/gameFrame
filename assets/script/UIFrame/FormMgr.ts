...
export default class FormMgr {
     ...
     */
    public static async open(form: IFormConfig, param?: any, formData?: IFormData) {
        switch (form.type) {
    ...
    public static async close(form: IFormConfig) {
        switch (form.type) {
            case FormType.Screen:
    ...
    public static async backScene(params?: any, formData?: IFormData) {
        return SceneMgr.back(params, formData);
    }

    public static async closeAllWindows() {
